function(parse_version_string VERSION_STRING)
  ...
  set(SANDALS_VERSION ${BASE_VERSION} CACHE INTERNAL "")
  set(SANDALS_VERSION_PRERELEASE ${PRE_RELEASE} CACHE INTERNAL "")
endfunction()
...
function(get_version_from_git)
  ...
  set(SANDALS_VERSION "0.0.0" CACHE INTERNAL "")
  set(SANDALS_VERSION_PRERELEASE "" CACHE INTERNAL "")
endfunction()

function(write_version_file)
  if(NOT SANDALS_VERSION)
    message(FATAL_ERROR "SANDALS_VERSION is not set")
  endif()

  set(VERSION_STRING "${SANDALS_VERSION}")
  if(SANDALS_VERSION_PRERELEASE)
