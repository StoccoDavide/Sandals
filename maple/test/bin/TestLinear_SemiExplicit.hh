...
class Test : public SemiExplicit<2, 0> {
 ...
 public:
  ...
  MatrixA A(const VectorF & /*in_0*/, Real /*in_1*/) const override {
    // Create data' aliases
    // None
  ...
  TensorTA TA_x(const VectorF & /*in_0*/, Real /*in_1*/) const override {
    // Create data' aliases
    // None
  ...
  VectorB b(const VectorF &in_0, Real in_1) const override {
    // Create data' aliases
    ...
    const Real &t     = in_1;     // Independent variable (or time)
  ...
  MatrixJB Jb_x(const VectorF & /*in_0*/, Real in_1) const override {
    // Create data' aliases
    const Real &l = this->m_l;  // Pendulum length (m)
    const Real &g = this->m_g;  // Gravity acceleration (m/s^2)
    ...
    // Return results
    MatrixJB out_Jb_x;
    out_Jb_x << out_0_0, out_0_1, out_1_0, out_1_1;
    return out_Jb_x;
  }
