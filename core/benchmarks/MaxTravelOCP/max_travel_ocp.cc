...
int main(int argc, char **argv) {
  ...
  TGraph *graph_v  = to_TGraph(solution.t, solution.eigen_x(1));
  ...
  auto legend1 = new TLegend(0.8, 0.8, 0.9, 0.9);
  legend1->AddEntry(graph_x, "x", "l");
  legend1->AddEntry(graph_v, "v", "l");
  legend1->Draw();
  ...
  auto legend2 = new TLegend(0.8, 0.8, 0.9, 0.9);
