...
#ifndef TESTS_PROBLEMS_BVPT27_HH
#define TESTS_PROBLEMS_BVPT27_HH
...
class BVPT27Explicit : public Explicit<Real, 2, 0> {
 public:
 ...
 public:
  BVPT27Explicit() : Explicit<Real, 2, 0>("BVPT27Explicit") {}
  ~BVPT27Explicit() {}
...
template <typename Real = double>
class BVPT27Implicit : public Implicit<Real, 2, 0> {
 public:
 ...
 public:
  BVPT27Implicit() : Implicit<Real, 2, 0>("BVPT27Implicit") {}
  ~BVPT27Implicit() {}
...
template <typename Real = double>
class BVPT27SemiExplicit : public SemiExplicit<Real, 2, 0> {
 public:
 ...
 public:
  BVPT27SemiExplicit() : SemiExplicit<Real, 2, 0>("BVPT27SemiExplicit") {}
  ~BVPT27SemiExplicit() {}
...
class BVPT27Problem : public BVP<Real, 2, 0, Integrator> {
 public:
  ...
  BVPT27Problem()
      : BVP<Real, 2, 0, Integrator>("BVPT27Problem",
...
#endif  // TESTS_PROBLEMS_BVPT27_HH
