...
#ifndef TESTS_PROBLEMS_BVPT14_HH
#define TESTS_PROBLEMS_BVPT14_HH
...
class BVPT14Explicit : public Explicit<Real, 2, 0> {
 public:
 ...
 public:
  BVPT14Explicit() : Explicit<Real, 2, 0>("BVPT14Explicit") {}
  ~BVPT14Explicit() {}
...
template <typename Real = double>
class BVPT14Implicit : public Implicit<Real, 2, 0> {
 public:
 ...
 public:
  BVPT14Implicit() : Implicit<Real, 2, 0>("BVPT14Implicit") {}
  ~BVPT14Implicit() {}
...
template <typename Real = double>
class BVPT14SemiExplicit : public SemiExplicit<Real, 2, 0> {
 public:
 ...
 public:
  BVPT14SemiExplicit() : SemiExplicit<Real, 2, 0>("BVPT14SemiExplicit") {}
  ~BVPT14SemiExplicit() {}
...
class BVPT14Problem : public BVP<Real, 2, 0, Integrator> {
 public:
 ...
 public:
  BVPT14Problem()
      : BVP<Real, 2, 0, Integrator>("BVPT14Problem",
  ...
  VectorX exact_solution(const VectorX &t) const {
    ...
    for (Integer i{0}; i < t.size(); ++i) {
      x(i) = BVPT14Problem<Real, System, Integrator>::exact_solution(t(i));
    }
    return x;
  }
...
#endif  // TESTS_PROBLEMS_BVPT14_HH
