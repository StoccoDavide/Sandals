...
#ifndef TESTS_PROBLEMS_BVPT15_HH
#define TESTS_PROBLEMS_BVPT15_HH
...
class BVPT15Explicit : public Explicit<Real, 2, 0> {
 public:
 ...
 public:
  BVPT15Explicit() : Explicit<Real, 2, 0>("BVPT15Explicit") {}
  ~BVPT15Explicit() {}
...
template <typename Real = double>
class BVPT15Implicit : public Implicit<Real, 2, 0> {
 public:
 ...
 public:
  BVPT15Implicit() : Implicit<Real, 2, 0>("BVPT15Implicit") {}
  ~BVPT15Implicit() {}
  ...
  VectorF F(const VectorF &x,
    ...
    VectorF F;
    F << x_dot(0) - x(1), x_dot(1) - t * x(0) / this->m_lambda;
    return F;
  }
...
template <typename Real = double>
class BVPT15SemiExplicit : public SemiExplicit<Real, 2, 0> {
 public:
 ...
 public:
  BVPT15SemiExplicit() : SemiExplicit<Real, 2, 0>("BVPT15SemiExplicit") {}
  ~BVPT15SemiExplicit() {}
...
class BVPT15Problem : public BVP<Real, 2, 0, Integrator> {
 public:
  ...
  BVPT15Problem()
      : BVP<Real, 2, 0, Integrator>("BVPT15Problem",
...
#endif  // TESTS_PROBLEMS_BVPT15_HH
