...
#ifndef TESTS_PROBLEMS_BVPT11_HH
#define TESTS_PROBLEMS_BVPT11_HH
...
class BVPT11Explicit : public Explicit<Real, 2, 0> {
 public:
 ...
 public:
  BVPT11Explicit() : Explicit<Real, 2, 0>("BVPT11Explicit") {}
...
template <typename Real = double>
class BVPT11Implicit : public Implicit<Real, 2, 0> {
 public:
 ...
 public:
  BVPT11Implicit() : Implicit<Real, 2, 0>("BVPT11Implicit") {}
  ~BVPT11Implicit() {}
...
template <typename Real = double>
class BVPT11SemiExplicit : public SemiExplicit<Real, 2, 0> {
 public:
 ...
 public:
  BVPT11SemiExplicit() : SemiExplicit<Real, 2, 0>("BVPT11SemiExplicit") {}
  ~BVPT11SemiExplicit() {}
...
class BVPT11Problem : public BVP<Real, 2, 0, Integrator> {
 public:
 ...
 public:
  BVPT11Problem()
      : BVP<Real, 2, 0, Integrator>("BVPT11Problem",
  ...
  VectorX exact_solution(const VectorX &t) const {
    ...
    for (Integer i{0}; i < t.size(); ++i) {
      x(i) = BVPT11Problem<Real, System, Integrator>::exact_solution(t(i));
    }
    return x;
  }
...
#endif  // TESTS_PROBLEMS_BVPT11_HH
