...
#ifndef TESTS_PROBLEMS_BVPT29_HH
#define TESTS_PROBLEMS_BVPT29_HH
...
class BVPT29Explicit : public Explicit<Real, 2, 0> {
 public:
 ...
 public:
  BVPT29Explicit() : Explicit<Real, 2, 0>("BVPT29Explicit") {}
  ~BVPT29Explicit() {}
...
template <typename Real = double>
class BVPT29Implicit : public Implicit<Real, 2, 0> {
 public:
 ...
 public:
  BVPT29Implicit() : Implicit<Real, 2, 0>("BVPT29Implicit") {}
  ~BVPT29Implicit() {}
...
class BVPT29SemiExplicit : public SemiExplicit<Real, 2, 0> {
 ...
 public:
  BVPT29SemiExplicit() : SemiExplicit<Real, 2, 0>("BVPT29SemiExplicit") {}
  ~BVPT29SemiExplicit() {}
...
class BVPT29Problem : public BVP<Real, 2, 0, Integrator> {
 public:
  ...
  BVPT29Problem()
      : BVP<Real, 2, 0, Integrator>("BVPT29Problem",
...
#endif  // TESTS_PROBLEMS_BVPT29_HH
