...
#ifndef TESTS_PROBLEMS_BVPT26_HH
#define TESTS_PROBLEMS_BVPT26_HH
...
class BVPT26Explicit : public Explicit<Real, 2, 0> {
 public:
 ...
 public:
  BVPT26Explicit() : Explicit<Real, 2, 0>("BVPT26Explicit") {}
  ~BVPT26Explicit() {}
...
template <typename Real = double>
class BVPT26Implicit : public Implicit<Real, 2, 0> {
 public:
 ...
 public:
  BVPT26Implicit() : Implicit<Real, 2, 0>("BVPT26Implicit") {}
  ~BVPT26Implicit() {}
...
template <typename Real = double>
class BVPT26SemiExplicit : public SemiExplicit<Real, 2, 0> {
 public:
 ...
 public:
  BVPT26SemiExplicit() : SemiExplicit<Real, 2, 0>("BVPT26SemiExplicit") {}
  ~BVPT26SemiExplicit() {}
...
class BVPT26Problem : public BVP<Real, 2, 0, Integrator> {
 public:
  ...
  BVPT26Problem()
      : BVP<Real, 2, 0, Integrator>("BVPT26Problem",
...
#endif  // TESTS_PROBLEMS_BVPT26_HH
