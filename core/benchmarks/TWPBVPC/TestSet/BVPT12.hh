...
#ifndef TESTS_PROBLEMS_BVPT12_HH
#define TESTS_PROBLEMS_BVPT12_HH
...
class BVPT12Explicit : public Explicit<Real, 2, 0> {
 public:
 ...
 public:
  BVPT12Explicit() : Explicit<Real, 2, 0>("BVPT12Explicit") {}
  ~BVPT12Explicit() {}
...
template <typename Real = double>
class BVPT12Implicit : public Implicit<Real, 2, 0> {
 public:
 ...
 public:
  BVPT12Implicit() : Implicit<Real, 2, 0>("BVPT12Implicit") {}
  ~BVPT12Implicit() {}
...
template <typename Real = double>
class BVPT12SemiExplicit : public SemiExplicit<Real, 2, 0> {
 public:
 ...
 public:
  BVPT12SemiExplicit() : SemiExplicit<Real, 2, 0>("BVPT12SemiExplicit") {}
  ~BVPT12SemiExplicit() {}
...
class BVPT12Problem : public BVP<Real, 2, 0, Integrator> {
 public:
 ...
 public:
  BVPT12Problem()
      : BVP<Real, 2, 0, Integrator>("BVPT12Problem",
  ...
  VectorX exact_solution(const VectorX &t) const {
    ...
    for (Integer i{0}; i < t.size(); ++i) {
      x(i) = BVPT12Problem<Real, System, Integrator>::exact_solution(t(i));
    }
    return x;
  }
...
#endif  // TESTS_PROBLEMS_BVPT12_HH
