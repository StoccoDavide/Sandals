...
#ifndef TESTS_PROBLEMS_BVPT18_HH
#define TESTS_PROBLEMS_BVPT18_HH
...
class BVPT18Explicit : public Explicit<Real, 2, 0> {
 public:
 ...
 public:
  BVPT18Explicit() : Explicit<Real, 2, 0>("BVPT18Explicit") {}
  ~BVPT18Explicit() {}
...
template <typename Real = double>
class BVPT18Implicit : public Implicit<Real, 2, 0> {
 public:
 ...
 public:
  BVPT18Implicit() : Implicit<Real, 2, 0>("BVPT18Implicit") {}
  ~BVPT18Implicit() {}
...
template <typename Real = double>
class BVPT18SemiExplicit : public SemiExplicit<Real, 2, 0> {
 public:
 ...
 public:
  BVPT18SemiExplicit() : SemiExplicit<Real, 2, 0>("BVPT18SemiExplicit") {}
  ~BVPT18SemiExplicit() {}
...
class BVPT18Problem : public BVP<Real, 2, 0, Integrator> {
 public:
  ...
  BVPT18Problem()
      : BVP<Real, 2, 0, Integrator>("BVPT18Problem",
  ...
  VectorX exact_solution(const VectorX &t) const {
    ...
    for (Integer i{0}; i < t.size(); ++i) {
      x(i) = BVPT18Problem<Real, System, Integrator>::exact_solution(t(i));
    }
    return x;
  }
...
#endif  // TESTS_PROBLEMS_BVPT18_HH
