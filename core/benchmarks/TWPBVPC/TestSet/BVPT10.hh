...
#ifndef TESTS_PROBLEMS_BVPT10_HH
#define TESTS_PROBLEMS_BVPT10_HH
...
class BVPT10Explicit : public Explicit<Real, 2, 0> {
 public:
 ...
 public:
  BVPT10Explicit() : Explicit<Real, 2, 0>("BVPT10Explicit") {}
...
template <typename Real = double>
class BVPT10Implicit : public Implicit<Real, 2, 0> {
 public:
 ...
 public:
  BVPT10Implicit() : Implicit<Real, 2, 0>("BVPT10Implicit") {}
  ...
  VectorF F(const VectorF &x,
    ...
    VectorF F;
    F << x_dot(0) - x(1), x_dot(1) + t * x(1) / this->m_lambda;
    return F;
  }
...
template <typename Real = double>
class BVPT10SemiExplicit : public SemiExplicit<Real, 2, 0> {
 public:
 ...
 public:
  BVPT10SemiExplicit() : SemiExplicit<Real, 2, 0>("BVPT10SemiExplicit") {}
...
class BVPT10Problem : public BVP<Real, 2, 0, Integrator> {
 public:
  ...
  BVPT10Problem()
      : BVP<Real, 2, 0, Integrator>("BVPT10Problem",
  ...
  VectorX exact_solution(const VectorX &t) const {
    ...
    for (Integer i{0}; i < t.size(); ++i) {
      x(i) = BVPT10Problem<Real, System, Integrator>::exact_solution(t(i));
    }
    return x;
  }
...
#endif  // TESTS_PROBLEMS_BVPT10_HH
