...
#ifndef TESTS_PROBLEMS_BVPT28_HH
#define TESTS_PROBLEMS_BVPT28_HH
...
class BVPT28Explicit : public Explicit<Real, 2, 0> {
 public:
 ...
 public:
  BVPT28Explicit() : Explicit<Real, 2, 0>("BVPT28Explicit") {}
  ~BVPT28Explicit() {}
...
template <typename Real = double>
class BVPT28Implicit : public Implicit<Real, 2, 0> {
 public:
 ...
 public:
  BVPT28Implicit() : Implicit<Real, 2, 0>("BVPT28Implicit") {}
  ~BVPT28Implicit() {}
...
template <typename Real = double>
class BVPT28SemiExplicit : public SemiExplicit<Real, 2, 0> {
 public:
 ...
 public:
  BVPT28SemiExplicit() : SemiExplicit<Real, 2, 0>("BVPT28SemiExplicit") {}
  ~BVPT28SemiExplicit() {}
...
class BVPT28Problem : public BVP<Real, 2, 0, Integrator> {
 public:
  ...
  BVPT28Problem()
      : BVP<Real, 2, 0, Integrator>("BVPT28Problem",
...
#endif  // TESTS_PROBLEMS_BVPT28_HH
