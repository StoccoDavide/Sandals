...
#ifndef SANDALS_RUNGE_KUTTA_RADAUIIA3_HH
#define SANDALS_RUNGE_KUTTA_RADAUIIA3_HH
...
namespace Sandals {
  ...
  class RadauIIA3Tableau : public Tableau<Real, 2> {
   public:
    ...
    RadauIIA3Tableau<Real>() {
      ...
      this->type  = Type::IRK;
      this->order = 3;
      this->A << 5.0 / 12.0, -1.0 / 12.0, 3.0 / 4.0, 1.0 / 4.0;
  ...
  class RadauIIA3 : public RungeKutta<Real, 2, N, M> {
   public:
    ...
    /**
     * Class constructor for a Radau IIA order 3 solver given a Tableau
     * reference.
     */
     ...
     */
    RadauIIA3(SystemPtr t_system)
        : RungeKutta<Real, 2, N, M>(RadauIIA3Tableau<Real>(),
                                    std::move(t_system)) {}
...
#endif  // SANDALS_RUNGE_KUTTA_RADAUIIA3_HH
