...
namespace Sandals {
  ...
  */
   ...
   * \f]
   *
   * with \f$ t_1 = \sqrt{15}/10 \f$, \f$ t_2 = \sqrt{15}/15 \f$, \f$ t_3 =
   * \sqrt{15}/24 \f$, \f$ t_4 = \sqrt{15}/30 \f$, \f$ w = 5/36 \f$, and \f$ z =
   * 2/9 \f$.
   */
  ...
  class GaussLegendre6Tableau : public Tableau<Real, 3> {
   public:
    ...
    GaussLegendre6Tableau<Real>() {
      ...
      Real w{5.0 / 36.0};
      Real z{2.0 / 9.0};
      this->A << w, z - t_2, w - t_4, w + t_3, z, w - t_3, w + t_4, z + t_2, w;
  ...
  class GaussLegendre6 : public RungeKutta<Real, 3, N, M> {
   public:
     ...
     */
    GaussLegendre6()
        : RungeKutta<Real, 3, N, M>(GaussLegendre6Tableau<Real>()) {}

    /**
     * Class constructor for a Runge-Kutta solver given a Tableau reference.
     * \param[in] t_system The system reference.
     */
    GaussLegendre6(SystemPtr t_system)
        : RungeKutta<Real, 3, N, M>(GaussLegendre6Tableau<Real>(),
                                    std::move(t_system)) {}
