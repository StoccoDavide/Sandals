...
#ifndef SANDALS_RUNGE_KUTTA_RALSTON4_HH
#define SANDALS_RUNGE_KUTTA_RALSTON4_HH
...
namespace Sandals {
  ...
  class Ralston4Tableau : public Tableau<Real, 4> {
   public:
    ...
    Ralston4Tableau<Real>() {
      ...
      this->A << 0.0, 0.0, 0.0, 0.0, a_21, 0.0, 0.0, 0.0, a_31, a_32, 0.0, 0.0,
          a_41, a_42, a_43, 0.0;
  ...
  class Ralston4 : public RungeKutta<Real, 4, N, M> {
   public:
    ...
    /**
     * Class constructor for a Ralston's order 4 solver given a Tableau
     * reference.
     */
     ...
     */
    Ralston4(SystemPtr t_system)
        : RungeKutta<Real, 4, N, M>(Ralston4Tableau<Real>(),
                                    std::move(t_system)) {}
...
#endif  // SANDALS_RUNGE_KUTTA_RALSTON4_HH
