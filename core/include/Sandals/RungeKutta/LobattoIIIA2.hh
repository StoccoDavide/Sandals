...
#ifndef SANDALS_RUNGE_KUTTA_LOBATTOIIIA2_HH
#define SANDALS_RUNGE_KUTTA_LOBATTOIIIA2_HH
  ...
  class LobattoIIIA2Tableau : public Tableau<Real, 2> {
   public:
    ...
    LobattoIIIA2Tableau<Real>() {
      ...
      this->type  = Type::DIRK;
      this->order = 2;
      this->A << 0.0, 0.0, 1.0 / 2.0, 1.0 / 2.0;
...
#endif  // SANDALS_RUNGE_KUTTA_LOBATTOIIIA2_HH
