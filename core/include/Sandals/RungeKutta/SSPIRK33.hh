...
#ifndef SANDALS_RUNGE_KUTTA_SSPIRK33_HH
#define SANDALS_RUNGE_KUTTA_SSPIRK33_HH
...
namespace Sandals {
  /**
   * \brief Butcher tableau for the 3-stage diagonally-implicit strong-stability
   * preserving Runge-Kuttax order 3 method.
   *
   * Butcher tableau for the 3-stage diagonally-implicit strong-stability
   * preserving Runge-Kutta order 3 method:
   *
   * \f[
   * \begin{array}{c|ccc}
  ...
  class SSPIRK33Tableau : public Tableau<Real, 3> {
   public:
    ...
    /**
     * Class constructor for the 3-stage diagonally-implicit strong-stability
     * preserving Runge-Kutta order 3 method.
     */
    SSPIRK33Tableau<Real>() {
      ...
      Real t_4{t_1 - t_2};
      Real t_5{t_1 + t_2};
      this->A << t_4, 0.0, 0.0, t_2, t_4, 0.0, t_2, t_2, t_4;
      this->b << t_3, t_3, t_3;
      this->c << t_4, t_1, t_5;
    }
  ...
  /**
   * \brief Class container for the 3-stage diagonally-implicit strong-stability
   * preserving Runge-Kutta order 3 method.
   *
   * Class container for the 3-stage diagonally-implicit strong-stability
   * preserving Runge-Kutta order 3 method.
   * \tparam Real The scalar number type.
  ...
  class SSPIRK33 : public RungeKutta<Real, 3, N, M> {
   public:
     ...
     */
    SSPIRK33(SystemPtr t_system)
        : RungeKutta<Real, 3, N, M>(SSPIRK33Tableau<Real>(),
                                    std::move(t_system)) {}
...
#endif  // SANDALS_RUNGE_KUTTA_SSPIRK33_HH
