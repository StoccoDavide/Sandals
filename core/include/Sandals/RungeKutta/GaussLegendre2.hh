...
#ifndef SANDALS_RUNGE_KUTTA_GAUSSLEGENDRE2_HH
#define SANDALS_RUNGE_KUTTA_GAUSSLEGENDRE2_HH
...
namespace Sandals {
  ...
  Kaifeng Xia, Yuhao Cong and Geng Sun. Journal of Applied Analysis ans
  Computation, Volume 7, Number 3, 2017(8), 1185-1199
  ...
  */
  ...
  class GaussLegendre2 : public RungeKutta<Real, 1, N, M> {
   public:
    ...
    /**
     * Class constructor for a Gauss-Legendre order 2 solver given a Tableau
     * reference.
     */
    GaussLegendre2()
        : RungeKutta<Real, 1, N, M>(GaussLegendre2Tableau<Real>()) {}
     ...
     */
    GaussLegendre2(SystemPtr t_system)
        : RungeKutta<Real, 1, N, M>(GaussLegendre2Tableau<Real>(),
                                    std::move(t_system)) {}
...
#endif  // SANDALS_RUNGE_KUTTA_GAUSSLEGENDRE2_HH
