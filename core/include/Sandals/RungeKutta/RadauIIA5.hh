...
#ifndef SANDALS_RUNGE_KUTTA_RADAUIIA5_HH
#define SANDALS_RUNGE_KUTTA_RADAUIIA5_HH
  ...
  class RadauIIA5Tableau : public Tableau<Real, 3> {
   public:
    ...
    RadauIIA5Tableau<Real>() {
      ...
      this->A << 11.0 / 45.0 - 7.0 * s6 / 360.0,
          37.0 / 225.0 - 169.0 * s6 / 1800.0, -2.0 / 225.0 + s6 / 75.0,
          37.0 / 225 + 169.0 * s6 / 1800.0, 11.0 / 45.0 + 7.0 * s6 / 360.0,
          -2.0 / 225.0 - s6 / 75.0, 4.0 / 9.0 - s6 / 36.0,
          4.0 / 9.0 + s6 / 36.0, 1.0 / 9.0;
...
#endif  // SANDALS_RUNGE_KUTTA_RADAUIIA5_HH
