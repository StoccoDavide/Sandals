...
class SinExplicit : public Explicit<Real, 1, 0> {
 public:
  using typename Explicit<Real, 1, 0>::VectorF;
  using typename Explicit<Real, 1, 0>::MatrixJF;
  using typename Explicit<Real, 1, 0>::VectorH;
  using typename Explicit<Real, 1, 0>::MatrixJH;
