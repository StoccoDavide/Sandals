...
#ifndef SANDALS_RALSTON4_HXX
#define SANDALS_RALSTON4_HXX
...
namespace Sandals
{
  ...
  template <Size N>
  class Ralston4 : public RungeKutta<4, N>
  {
  public:
    ...
    //!
    Ralston4() : RungeKutta<4, N>(Ralston4Tableau()) {}

    //! Class constructor for a Ralston's order 4 solver given a Tableau reference.
    //! \param[in] t_system The system reference.
    Ralston4(System t_system) : RungeKutta<4, N>(Ralston4Tableau(), t_system) {}

  }; // class Ralston4

} // namespace Sandals

#endif // SANDALS_RALSTON4_HXX
