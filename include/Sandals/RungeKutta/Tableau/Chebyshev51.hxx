...
namespace Sandals
{
  ...
  {
    public:
    using Tableau<5>::Type;   //!< Runge-Kutta type enumeration.
    using Tableau<5>::Vector; //!< Templetized vector type.
    using Tableau<5>::Matrix; //!< Templetized matrix type.
  ...
  template <Size N>
  class Chebyshev51 : public RungeKutta<5, N>
  {
  public:
    ...
    //!
    Chebyshev51() : RungeKutta<5, N>(Chebyshev51Tableau()) {}

    //! Class constructor for a 5-stage Runge-Kutta-Chebyshev order 1 solver given a Tableau reference.
    //! \param[in] t_system The system reference.
    Chebyshev51(System t_system) : RungeKutta<5, N>(Chebyshev51Tableau(), t_system) {}
