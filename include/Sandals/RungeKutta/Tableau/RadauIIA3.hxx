...
namespace Sandals
{
  //! Butcher tableau for the RadauIIA3 method:
  //!
  //! \f[
  //! \begin{array}{c|cc}
  //!   1/3 & 5/12 & -1/12 \\
  ...
  class RadauIIA3Tableau : public Tableau<2>
  {
    ...
    //! Class constructor for the RadauIIA3 method.
    RadauIIA3Tableau() {
      this->name  = "RadauIIA3";
      this->type  = Type::IRK;
      this->order = 3;
  ...
  //! Class container for the RadauIIA3 method.
  template <Size N>
  ...
  public:
    ...
    //! Class constructor for a RadauIIA3 solver given a Tableau reference.
