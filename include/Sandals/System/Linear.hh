...
namespace Sandals {
  ...
  */
  ...
  public:
    ...
    */
    MatrixJF JF_x(VectorF const & /*x*/, VectorF const & /*x_dot*/, Real const t) const override {return -this->A(t);}
    ...
    */
    MatrixJF JF_x_dot(VectorF const & /*x*/, VectorF const & /*x_dot*/, Real const t) const override {return this->E(t);}
