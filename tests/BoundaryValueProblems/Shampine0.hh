...
class Shampine0Problem : public BoundaryValueProblem<Real, 2, 0, Integrator>
{
public:
  ...
  Shampine0Problem()
    : BoundaryValueProblem<Real, 2, 0, Integrator>("Shampine0Problem", std::make_unique<System>(),
