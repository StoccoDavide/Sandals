...
class Hypersensitive0Problem : public BoundaryValueProblem<Real, 4, 0, Integrator>
{
public:
  ...
  Hypersensitive0Problem()
    : BoundaryValueProblem<Real, 4, 0, Integrator>("Hypersensitive0Problem", std::make_unique<System>(),
  ...
  MatrixX exact_solution(VectorX const & t) const {return MatrixX::Zero(4, t.size());}
