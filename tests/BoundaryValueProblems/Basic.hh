...
class BasicProblem : public BoundaryValueProblem<Real, 2, 0, Integrator>
{
public:
  ...
  BasicProblem()
    : BoundaryValueProblem<Real, 2, 0, Integrator>("BasicProblem", std::make_unique<System>(), std::make_unique<Integrator>()) {}
