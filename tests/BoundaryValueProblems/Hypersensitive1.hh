...
class Hypersensitive1Problem : public BoundaryValueProblem<Real, 2, 0, Integrator>
{
public:
  ...
  Hypersensitive1Problem()
    : BoundaryValueProblem<Real, 2, 0, Integrator>("Hypersensitive1Problem", std::make_unique<System>(),
